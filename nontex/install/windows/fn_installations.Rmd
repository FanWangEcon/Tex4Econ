...
conda deactivate
conda list env
conda env remove -n wk_nodejs
conda create -n wk_nodejs -y
conda activate wk_nodejs

conda install -c conda-forge nodejs -y
# ended up downloading installer for windows nodejs and installing out of conda
# was having lots of bugs
npm i -g --production windows-build-tools
npm install -g --force decktape
# use yaml2tex
