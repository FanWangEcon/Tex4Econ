...
*note*: Github people seem to have slowed down updating Atom since microsoft acquisition
...
In addition to Atom, which is pretty slow, and harder to run on lower spec computers.
...
# Change Font (https://www.reddit.com/r/Crostini/comments/cesxr0/vscode_ui_and_fonts_too_small_heres_how_to_fix_it/)
...
2. [Microsoft Python Extension](https://marketplace.visualstudio.com/items?itemName=ms-python.python)
...
1. download [Latex Workshop](https://marketplace.visualstudio.com/items?itemName=James-Yu.latex-workshop)
...
- PDF Okular
    ...
    + Automatic Update when PDF updated elsewhere
        * this is one of the key reasons to use okular, when I knit a Rmd file to PDF, the currently open Okular PDF file automatically updates and does not give file is open error like Acrobat.
    + Background color:
